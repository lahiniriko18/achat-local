...
function Categorie() {
  ...
  const handleDetails = (categorie) => {
    navigate(`/categorie/details/${categorie.numCategorie}`, {
      state: { categorie },
    });
  };
  const hideModal = () => {
  ...
  return (
    <div className="flex h-full flex-col p-3 overflow-auto">
      <h2 className="font-semibold  text-2xl">Catégorie</h2>
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-2 items-center">
            ...
            <select
              ...
              className="outline-none rounded px-2 py-1 text-sm 
                      ...
                      >
                        ...
                        <td className="py-2 px-6">
                          <div className="flex justify-center space-x-4">
                            ...
                            />
                            <Info
                              onClick={() => handleDetails(categorie)}
