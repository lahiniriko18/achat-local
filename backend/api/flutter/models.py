...
class Classement(models.Model):
    ...
    quantiteMax = models.FloatField(null=True, blank=True)
    descClassement = models.TextField(null=True, blank=True)
...
class Categorie(models.Model):
    ...
    imageCategorie = models.ImageField(
        upload_to="images/categories/", null=True, blank=True
    )
    descCategorie = models.TextField(null=True, blank=True)
...
class Produit(models.Model):
    ...
    prixUnitaire = models.FloatField(null=True, blank=True)
    uniteMesure = models.CharField(10, null=True, blank=True)
    description = models.TextField(null=True, blank=True)
    qrCode = models.ImageField(
        upload_to="images/produits/qrcode/", null=True, blank=True
    )
...
class Image(models.Model):
    ...
    numProduit = models.ForeignKey(
        Produit, related_name="images", on_delete=models.CASCADE, db_column="numProduit"
    )
    nomImage = models.ImageField(
        upload_to="images/produits/images/", null=True, blank=True
    )
