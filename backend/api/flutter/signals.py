...
from .models import Categorie, Produit, Comprendre, Image
...
def auto_delete_image_on_delete(sender, instance, **kwargs):
    if instance.nomImage:
        instance.nomImage.delete(save=False)
...
#     try:
#         ancienImage = Utilisateur.objects.get(pk=instance.pk).image
#     except Utilisateur.DoesNotExist:
#         return False

#     nouveauImage = instance.image
#     if ancienImage and ancienImage != nouveauImage:
#         ancienImage.delete(save=False)
