...
class RechercheProduit extends StatefulWidget {
  ...
  @override
  State<RechercheProduit> createState() => RechercheProduitState();
}

class RechercheProduitState extends State<RechercheProduit> {
  List<Produit> produitFiltres = [];
  ...
  void initState() {
    super.initState();
    produitFiltres = widget.produits;
  ...
  void filtrage(String valeur) {
    ...
    setState(() {
      produitFiltres = widget.produits.where((p) {
