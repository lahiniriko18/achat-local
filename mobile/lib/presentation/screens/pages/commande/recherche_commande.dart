...
class RechercheCommande extends StatefulWidget {
  ...
  @override
  State<RechercheCommande> createState() => RechercheCommandeState();
}

class RechercheCommandeState extends State<RechercheCommande> {
  List<Commande> commandeFiltres = [];
  ...
  void initState() {
    super.initState();
    commandeFiltres = widget.commandes;
  }

  void filtrage(String valeur) {
    valeur = valeur.toLowerCase();
    setState(() {
      commandeFiltres = widget.commandes.where((c) {
        return c.toSearchableString().contains(valeur);
      }).toList();
    });
  }
