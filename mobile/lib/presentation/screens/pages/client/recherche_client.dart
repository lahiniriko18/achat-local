...
class RechercheClient extends StatefulWidget {
  ...
  @override
  State<RechercheClient> createState() => RechercheClientState();
}

class RechercheClientState extends State<RechercheClient> {
  List<Client> clientFiltres = [];
  ...
  void initState() {
    super.initState();
    clientFiltres = widget.clients;
  }

  void filtrage(String valeur) {
    valeur = valeur.toLowerCase();
    setState(() {
      clientFiltres = widget.clients.where((c) {
